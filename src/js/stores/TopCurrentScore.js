...
class TopCurrentScore extends EventEmitter {
  constructor() {
    super();
    this.topCurrentScore = [
      {
        "pk": 27,
        "username": "wseminario",
  ...
  getAll() {
    return this.topCurrentScore;
  }
}

const topCurrentScore = new TopCurrentScore;

export default topCurrentScore;
